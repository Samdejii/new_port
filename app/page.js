        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden lg:flex gap-6 xl:gap-8 items-center">
              ...
              <a href="/Software Engineer.pdf" download className="px-4 py-2 bg-gray-500 text-white rounded-lg text-sm font-medium hover:bg-gray-600 transition-all duration-300 flex items-center gap-2">
